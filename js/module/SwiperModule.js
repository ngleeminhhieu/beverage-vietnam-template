export default function SwiperModule() {
    ...
    const relatedNewsEl = document.querySelector(".related-news__slider .swiper")
    if (relatedNewsEl) {
        new Swiper(relatedNewsEl, {
            speed: 800,
            loop: true,
            spaceBetween: 24,
            slidesPerView: 3,
    ...
    const cefSliderEl = document.querySelector(".home-cef__slider .swiper")
    if (cefSliderEl) {
        new Swiper(cefSliderEl, {
            speed: 800,
            loop: true,
            spaceBetween: 24,
            slidesPerView: 4,
    ...
    const cateEl = document.querySelector(".home-cate__slider .swiper")
    if (cateEl) {
        new Swiper(cateEl, {
            slidesPerView: "auto",
            spaceBetween: 20,
    ...
    if (whyEl) {
        let whySwiper = null
        const whyMq = window.matchMedia("(max-width: 1024px)")
        const buildWhy = () => {
            if (whySwiper) return
